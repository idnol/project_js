...
const booksFromLocalStorage = getBooksFromLocalStorage(KEY_BOOK);

//&    відмальовую дані з LocalStorage
shoppingList.innerHTML = booksFromLocalStorage;
...
//&    функція що видаляє книгу з локального сховища
...
//&    слухач що видаля книгу по кліку на кнопку
